...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<button type=\"button\" class=\"btn-user btn-reset\" placement=\"bottom\" popoverClass=\"\"\r\n    ngbPopover=\"Vivamus sagittis lacus vel augue laoreet rutrum faucibus.\" popoverTitle=\"Popover on bottom\">\r\n    <span class=\"btn-user__text\">Sally Johnson</span>\r\n    <img class=\"btn-user__img\" src=\"../../assets/images/img_girl.png\" alt=\"icon person\">\r\n</button>");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopowerErrorMessages", function() { return PopowerErrorMessages; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InputPatterns", function() { return InputPatterns; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HealthCheckResult", function() { return HealthCheckResult; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BackendResponseCode", function() { return BackendResponseCode; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
//Login response code
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckRequestModel", function() { return CheckRequestModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnswerRequestModel", function() { return AnswerRequestModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateChildRequestModel", function() { return CreateChildRequestModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditProfileRequestModel", function() { return EditProfileRequestModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GetCountriesStatesModel", function() { return GetCountriesStatesModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class GetCountriesStatesModel {
}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FooterTheme", function() { return FooterTheme; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppComponentViewModel", function() { return AppComponentViewModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
var HeaderType;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddChildByCodeErrorViewModel", function() { return AddChildByCodeErrorViewModel; });
/* harmony import */ var _AppConstants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _BackendResponseCodes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class AddChildByCodeErrorViewModel {
    constructor() {
    ...
    setStateErrorByResponseCode(code) {
        if (!code)
            return;
        switch (code) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChildBaseModel", function() { return ChildBaseModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Child", function() { return Child; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class ChildBaseModel {
}
class Child extends ChildBaseModel {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateChildErrorViewModel", function() { return CreateChildErrorViewModel; });
/* harmony import */ var _AppConstants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _BackendResponseCodes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
...
class CreateChildErrorViewModel {
    constructor() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CreateChildModel", function() { return CreateChildModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditChildModel", function() { return EditChildModel; });
/* harmony import */ var _createChildModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createChildModel */ "./src/app/_models/children/createChildModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};

class EditChildModel extends _createChildModel__WEBPACK_IMPORTED_MODULE_0__["CreateChildModel"] {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CheckModelDTO", function() { return CheckModelDTO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Check", function() { return Check; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QRCodeData", function() { return QRCodeData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QRCodeDataModel", function() { return QRCodeDataModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class CheckModelDTO {
}
class Check extends CheckModelDTO {
}
class QRCodeData {
    constructor() {
        this.qrdata = null;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HealthTestViewModel", function() { return HealthTestViewModel; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PopowerErrorViewModel", function() { return PopowerErrorViewModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class PopowerErrorViewModel {
    hidePopower() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddFacilityViewModel", function() { return AddFacilityViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FacilityResponseModel", function() { return FacilityResponseModel; });
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};

class AddFacilityViewModel {
    constructor() {
    ...
    setAddFacilityDialogIsActive(state) {
        this.loading = false;
    ...
    facilityValueChanged() {
        this.setStateNoErrors();
    }
    onClickAddFacilityOpenDialog(event) {
        this.setAddFacilityDialogIsActive(true);
        setTimeout(() => $('#inputFacilityCode').focus(), 200);
    }
    closeDialogAddFacility() {
        if (!this.loading)
            this.setAddFacilityDialogIsActive(false);
    }
}
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChangaPasswordInputIcon", function() { return ChangaPasswordInputIcon; });
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class ChangePasswordViewModel {
    ...
    setChangePasswordDialogisActive(state) {
        this.loading = false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditProfileErrorViewModel", function() { return EditProfileErrorViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditUserViewModel", function() { return EditUserViewModel; });
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
/* harmony import */ var _BackendResponseCodes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
/* harmony import */ var _AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _user_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../user/user */ "./src/app/_models/user/user.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class EditProfileErrorViewModel {
    constructor() {
...
class EditUserViewModel {
    dateOfBirthToUTC() {
        try {
            if (this.dateOfBirthViewModel) {
                let dt = new Date(this.dateOfBirthViewModel);
    ...
    mapFrom(user) {
        ...
        try {
            let userDateOfBirth = new Date(user.dateOfBirth);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserRestorePasswordModel", function() { return UserRestorePasswordModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RestorePasswordErrorViewModel", function() { return RestorePasswordErrorViewModel; });
/* harmony import */ var _BackendResponseCodes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
/* harmony import */ var _services_helpers_validationService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class UserRestorePasswordModel {
}
class RestorePasswordErrorViewModel {
    constructor() {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivationRequestModel", function() { return ActivationRequestModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivationViewModel", function() { return ActivationViewModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class ActivationViewModel {
    setStateActivationInProgress() {
        this.activationInProgress = true;
        this.requestPending = true;
        this.requestReceived = false;
        this.activationSuccess = false;
    }
    setStateRequestReceived(activationSuccess) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserSignUpModel", function() { return UserSignUpModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SignUpErrorViewModel", function() { return SignUpErrorViewModel; });
/* harmony import */ var _popowerErrorViewModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../popowerErrorViewModel */ "./src/app/_models/popowerErrorViewModel.ts");
/* harmony import */ var _BackendResponseCodes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _user_user__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../user/user */ "./src/app/_models/user/user.ts");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FacilityModelDTO", function() { return FacilityModelDTO; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Country", function() { return Country; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "State", function() { return State; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocalSettings", function() { return LocalSettings; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BaseErrorViewModel", function() { return BaseErrorViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SignInErrorViewModel", function() { return SignInErrorViewModel; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateUserModel", function() { return UpdateUserModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class User {
...
class BaseErrorViewModel {
}
class SignInErrorViewModel extends BaseErrorViewModel {
    setStateNoError() {
        this.emailError = false;
        this.passwordError = false;
...
let ApiService = class ApiService {
    ...
    getUser(id) {
        return this.http.get(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl}/api/user/${id}`);
    }
    login(loginModel) {
        let body = JSON.stringify({ userName: loginModel.email, password: loginModel.password });
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + '/api/auth/login', { userName: loginModel.email, password: loginModel.password });
    }
    signUp(usignUpModel) {
    ...
    restorePassword(forgotpasswordModel) {
    ...
    updateProfile(userId, updateModel) {
    ...
    updateChildProfile(childId, updateModel) {
    ...
    getChecks(userId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + `/api/User/${userId}/checks`);
    }
    addFacility(body) {
    ...
    postAddChildByCode(id) {
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl}/api/Children/${id}`, {});
    }
    leaveFacility(userId, facilityId) {
        let params = {};
        params.userId = userId;
        params.facilityId = facilityId;
        return this.http.post(`${src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl}/api/User/leave-facility`, params);
    }
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProgressBarViewModel", function() { return ProgressBarViewModel; });
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
class Question {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CustomSurveyWizard", function() { return CustomSurveyWizard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SequenceStepper", function() { return SequenceStepper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProgressBarModel", function() { return ProgressBarModel; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SurveyResultFactory", function() { return SurveyResultFactory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnswerModel", function() { return AnswerModel; });
/* harmony import */ var src_app_models_api_requestModels_checkRequestModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/_models/api/requestModels/checkRequestModel */ "./src/app/_models/api/requestModels/checkRequestModel.ts");
/* harmony import */ var src_app_models_AppConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _CustomSurveyModels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CustomSurveyModels */ "./src/app/_services/customQuestionWizard/CustomSurveyModels.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class CustomSurveyWizard {
    constructor(questions, locale) {
    ...
    parseSurvey(baseSurvey, locale) {
        let localizedQuestions = baseSurvey.filter(x => { return x.languageCode === locale; });
        if (!localizedQuestions || localizedQuestions.length === 0)
            localizedQuestions = baseSurvey.filter(x => { return x.languageCode === this.EN_LANGUAGE_CODE; });
        if (!localizedQuestions || localizedQuestions.length === 0) {
            let locale = baseSurvey[0].languageCode;
            localizedQuestions = baseSurvey.filter(x => { return x.languageCode === locale; });
        }
        if (!localizedQuestions || localizedQuestions.length === 0)
            throw "Survey not valid";
        let groupedQuestions = localizedQuestions.sort((x, y) => {
    ...
    getSurveyAnswers(userId, facilityId, surveyId) {
...
class SequenceStepper {
    ...
    get isRichedFirstItem() {
        return this.currentIndex === 0;
    }
    get isRichedLastItem() {
...
class ProgressBarModel {
    ...
    getProgressViewModel() {
        let progressBarViewModel = new _CustomSurveyModels__WEBPACK_IMPORTED_MODULE_2__["ProgressBarViewModel"]();
...
class SurveyAnswersService {
    ...
    handleAnswer(question, answer, currentIndex) {
        let model = new AnswerModel(question, answer);
        this._answers[currentIndex] = model;
    }
}
class SurveyResultFactory {
    static GetResult(userId, facilityId, surveyId, answers) {
        let requestModel = new src_app_models_api_requestModels_checkRequestModel__WEBPACK_IMPORTED_MODULE_0__["CheckRequestModel"]();
        requestModel.userId = userId;
        requestModel.facilityId = facilityId;
        requestModel.surveyId = surveyId;
        answers.forEach(item => {
            let answerRequestModel = new src_app_models_api_requestModels_checkRequestModel__WEBPACK_IMPORTED_MODULE_0__["AnswerRequestModel"]();
...
/* harmony import */ var _dataProviderExtension_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dataProviderExtension.service */ "./src/app/_services/data-provider/dataProviderExtension.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let DataProviderService = class DataProviderService {
            ...
            this.afAuth.auth.signInAnonymously().then(() => {
                ...
                this.firestore.collection('global_news').get().subscribe(fireItem => {
                    ...
                    fireItem.docs.forEach((item) => {
                        var el = this.parseFirebaseItem(item.data(), item.id, labelId);
                        fireNews.push(el);
                        labelId++;
                    });
    ...
    parseFirebaseItem(item, id, labelId) {
        ...
        let itemImageUrl = `assets/background/default.jpg`;
...
DataProviderService.ctorParameters = () => [
...
class DataProviderExtension {
    ...
    static splitSequenceToRows(source, eltInOneRow) {
        debugger;
        const x = source.length / eltInOneRow;
        let rowsCount = Math.trunc(x); // returns 3
        let float_part = Number((x - rowsCount).toFixed(2)); // return 0.2
        if (float_part > 0)
            rowsCount++;
        let result = [];
        for (let index = 0; index < rowsCount; index++) {
            let part = source.slice(index * eltInOneRow, eltInOneRow);
            result.push(part);
        }
        return result;
    }
...
AuthGuard = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _localStorage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]])
], AuthGuard);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ApiBaseRequests", function() { return ApiBaseRequests; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_api_requestModels_getCountriesStatesModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_models/api/requestModels/getCountriesStatesModel */ "./src/app/_models/api/requestModels/getCountriesStatesModel.ts");
/* harmony import */ var _api_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api/api.service */ "./src/app/_services/api/api.service.ts");
...
/* harmony import */ var _childMapper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./childMapper */ "./src/app/_services/helpers/childMapper.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ApiBaseRequests = class ApiBaseRequests {
    ...
    getChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            let childrenResponseModel = yield this.apiService.getChildren().toPromise();
            var children = [];
            for (let index = 0; index < childrenResponseModel.items.length; index++) {
                let item = childrenResponseModel.items[index];
                let getUserByIdResponse = yield this.apiService.getUser(item.id).toPromise();
                let child = _childMapper__WEBPACK_IMPORTED_MODULE_4__["ChildMapper"].mapGetUserByIdResponseToChildModel(item.id, getUserByIdResponse);
                children.push(child);
            }
    ...
    getCountriesStates() {
        return __awaiter(this, void 0, void 0, function* () {
            let response = new src_app_models_api_requestModels_getCountriesStatesModel__WEBPACK_IMPORTED_MODULE_1__["GetCountriesStatesModel"]();
            let getCountriesResponse = yield this.apiService.getCountries().toPromise();
            response.countries = getCountriesResponse.items;
            this.localStorageService.setCountries(response.countries);
            let getStatesResponse = yield this.apiService.getStates().toPromise();
...
ApiBaseRequests.ctorParameters = () => [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChildMapper", function() { return ChildMapper; });
/* harmony import */ var src_app_models_api_requestModels_createChildRequestModel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! src/app/_models/api/requestModels/createChildRequestModel */ "./src/app/_models/api/requestModels/createChildRequestModel.ts");
/* harmony import */ var src_app_models_api_requestModels_editProfileRequestModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_models/api/requestModels/editProfileRequestModel */ "./src/app/_models/api/requestModels/editProfileRequestModel.ts");
/* harmony import */ var src_app_models_children_child__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_models/children/child */ "./src/app/_models/children/child.ts");
/* harmony import */ var src_app_models_children_editChildModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_models/children/editChildModel */ "./src/app/_models/children/editChildModel.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
class ChildMapper {
    static mapCreateChildRequest(child) {
        let model = new src_app_models_api_requestModels_createChildRequestModel__WEBPACK_IMPORTED_MODULE_0__["CreateChildRequestModel"];
        ...
        model.dateOfBirth = '';
        try {
            let numbers = child.dateOfBirth.split('/');
            let month = numbers[0];
            let date = numbers[1];
            let year = numbers[2];
            model.dateOfBirth = `${year}-${month}-${date}`;
        }
        catch (ex) { }
        return model;
    }
    static mapEditChildRequest(child) {
        let model = new src_app_models_api_requestModels_editProfileRequestModel__WEBPACK_IMPORTED_MODULE_1__["EditProfileRequestModel"];
        model.firstName = child.firstName;
        model.lastName = child.lastName;
        model.gender = child.gender;
        model.countryId = child.countryId;
    ...
    static mapGetUserByIdResponseToChildModel(id, response) {
        let child = new src_app_models_children_child__WEBPACK_IMPORTED_MODULE_2__["Child"]();
        child.id = id;
    ...
    static mapChildToEditChildMoldel(child) {
        let editModel = new src_app_models_children_editChildModel__WEBPACK_IMPORTED_MODULE_3__["EditChildModel"]();
        editModel.firstName = child.firstName;
        editModel.lastName = child.lastName;
        editModel.gender = child.gender;
        if (child.country && child.country.id)
            editModel.countryId = child.country.id;
        if (child.state && child.state.id)
            editModel.stateId = child.state.id;
        editModel.dateOfBirth = ChildMapper.parseDateOfBirthToUIString(child.dateOfBirth);
        return editModel;
    }
    static parseUIStringToDateOfBirthRequestString(dateString) {
        let result = '';
        try {
            ...
            if (month && date && year)
                ...
                console.error(`DateOfBirth string wrong format: ${dateString}`);
        }
        catch (ex) { }
        return result;
    }
    //dateString format 2020-01-01T00:00:00+00:00 to 01/01/2020
    static parseDateOfBirthToUIString(dateString) {
        let result = '';
        try {
            let yearMonthDate = dateString.split('T')[0];
            if (!yearMonthDate)
                return "";
            let splitted = yearMonthDate.split('-');
            let year = splitted[0];
...
class ContentHelper {
    static showEmailVerifyModal() {
        var body = document.querySelector('body');
        body.classList.add('modal-email-verify');
    }
    static closeEmailVerifyModal() {
        var body = document.querySelector('body');
    ...
    static chooseTabMyProfileChildren() {
...
/* harmony import */ var _localStorage_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../localStorage.service */ "./src/app/_services/localStorage.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AppInterceptor = class AppInterceptor {
    constructor(toastr, _router, http, authService, localStorageService) {
        this.toastr = toastr;
        this._router = _router;
        this.http = http;
    ...
    intercept(request, next) {
        ...
        return next.handle(request).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => {
            ...
            this.showToastrError(request, error);
            return next.handle(request);
        }));
    }
    handle401Error(request, next, currentUser) {
        if (!this.isRefreshing) {
            console.log("token refreshing");
            this.isRefreshing = true;
            this.refreshTokenSubject.next(null);
            return this.refreshToken(currentUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((token) => {
                this.isRefreshing = false;
    ...
    refreshToken(currentUser) {
        ...
        return this.authService.refreshToken(params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((response) => {
            this.updateUserToken(currentUser, response.accessToken, response.refreshToken);
    ...
    updateUserToken(currentUser, accessToken, refreshToken) {
    ...
    handle500(request, error) {
        let errorMessage = `Error occurred for request ${request.url} <br>StatusCode: ${error.status}<br><br>${error.message}`;
        if (error.error) {
            if (error.error.Message)
                errorMessage += `<hr style="border-top: 1px solid rgba(225,225,225);"><b>Details:</b><br>${error.error.Message}`;
            if (error.error.StackTrace)
                console.error(error.error.StackTrace);
        }
        this.toastr.errorToastr(errorMessage, 'Oops!', { enableHTML: true, dismiss: "click", showCloseButton: true });
    }
    showErrorToastr(request, error) {
        let errorMessage = `Error occurred for request ${request.url} <br>StatusCode: ${error.status}<br><br>${error.message}`;
        this.toastr.errorToastr(errorMessage, 'Oops!', { enableHTML: true, dismiss: "click", showCloseButton: true });
    }
};
...
AppInterceptor = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
    __metadata("design:paramtypes", [ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_5__["ToastrManager"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"],
        _auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"], _localStorage_service__WEBPACK_IMPORTED_MODULE_7__["LocalStorageService"]])
], AppInterceptor);
...
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
var __importDefault = (undefined && undefined.__importDefault) || function (mod) {
  return (mod && mod.__esModule) ? mod : { "default": mod };
};

class ValidationService {
    static ifEmailMatchPattern(email) {
        let regexp = new RegExp(_models_AppConstants__WEBPACK_IMPORTED_MODULE_0__["InputPatterns"].EMAIL_PATTERN);
        let res = regexp.test(email);
        return res;
    }
    static ifPasswordMatchPattern(password) {
        let regexp = new RegExp(_models_AppConstants__WEBPACK_IMPORTED_MODULE_0__["InputPatterns"].PASSWORD_PATTERN);
        let res = regexp.test(password);
        return res;
    }
    static ifNameMatchPattern(nameOrUserName) {
        let regexp = new RegExp(_models_AppConstants__WEBPACK_IMPORTED_MODULE_0__["InputPatterns"].USER_NAME_PATTERN);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let LanguageService = class LanguageService {
    getCurrentLanguage() {
        if (navigator)
            return this.parseLanguageCode(navigator.language);
        else
            _models_AppConstants__WEBPACK_IMPORTED_MODULE_1__["AppConstants"].EN_LANGUAGE_CODE;
    }
...
let LocalStorageService = class LocalStorageService {
    ...
    updateUserTokens(accessToken, refreshToken) {
        let currentUser = JSON.parse(localStorage.getItem(this.LOCAL_STORAGE_USER_KEY));
        currentUser.token = accessToken;
        currentUser.refreshToken = refreshToken;
    ...
    getCountries() {
        let countries = JSON.parse(localStorage.getItem(this.LOCAL_STORAGE_COUNTRIES_KEY));
        return countries;
    }
    getStates() {
        let states = JSON.parse(localStorage.getItem(this.LOCAL_STORAGE_STATES_KEY));
        return states;
    }
    ...
    getUser() {
        let user = JSON.parse(localStorage.getItem(this.LOCAL_STORAGE_USER_KEY));
    ...
    getChildById(id) {
        if (!id)
            throw "[getChildById]: Id not valid!";
        let children = JSON.parse(localStorage.getItem(this.LOCAL_STORAGE_CHILDREN_KEY));
        let child = children.find((item) => { return item.id === id; });
        if (!child)
            throw "[getChildById]: Child not found!";
        return child;
    }
    setChildren(children) {
        localStorage.setItem(this.LOCAL_STORAGE_CHILDREN_KEY, JSON.stringify(children));
    }
    userModelIsValid(user) {
        if (!user)
            return false;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RouteHandlerService", function() { return RouteHandlerService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_app_component_viewModels__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/app-component/viewModels */ "./src/app/_models/app-component/viewModels.ts");
/* harmony import */ var _helpers_contentHelper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let RouteHandlerService = class RouteHandlerService {
    constructor() {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_route_handler_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_services/route-handler.service */ "./src/app/_services/route-handler.service.ts");
/* harmony import */ var _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    ngOnInit() {
        this._router.events.subscribe((route) => {
            ...
            if (route instanceof _angular_router__WEBPACK_IMPORTED_MODULE_1__["NavigationEnd"]) {
                this.contentHandlerService.handleContentByRoute(route.url);
...
/* harmony import */ var _header_header_standart_header_standart_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./header/header-standart/header-standart.component */ "./src/app/header/header-standart/header-standart.component.ts");
/* harmony import */ var _header_header_base_header_base_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./header/header-base/header-base.component */ "./src/app/header/header-base/header-base.component.ts");
/* harmony import */ var _home_home_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./home/home.component */ "./src/app/home/home.component.ts");
/* harmony import */ var _footer_footer_primary_footer_primary_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./footer/footer-primary/footer-primary.component */ "./src/app/footer/footer-primary/footer-primary.component.ts");
/* harmony import */ var _footer_footer_white_footer_white_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./footer/footer-white/footer-white.component */ "./src/app/footer/footer-white/footer-white.component.ts");
/* harmony import */ var _health_test_health_test_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./health-test/health-test.component */ "./src/app/health-test/health-test.component.ts");
...
/* harmony import */ var _restore_password_restore_password_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./restore-password/restore-password.component */ "./src/app/restore-password/restore-password.component.ts");
/* harmony import */ var _layout_language_selector_language_selector_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./layout/language-selector/language-selector.component */ "./src/app/layout/language-selector/language-selector.component.ts");
...
/* harmony import */ var _services_script_loader_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./_services/script-loader.service */ "./src/app/_services/script-loader.service.ts");
/* harmony import */ var _layout_popover_popover_basic_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./layout/popover/popover-basic.module */ "./src/app/layout/popover/popover-basic.module.ts");
/* harmony import */ var _layout_dropdown_dropdown_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./layout/dropdown/dropdown.component */ "./src/app/layout/dropdown/dropdown.component.ts");
/* harmony import */ var _services_guard_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./_services/guard.service */ "./src/app/_services/guard.service.ts");
/* harmony import */ var _services_localStorage_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
...
/* harmony import */ var _ng_select_ng_option_highlight__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @ng-select/ng-option-highlight */ "./node_modules/@ng-select/ng-option-highlight/fesm2015/ng-select-ng-option-highlight.js");
/* harmony import */ var _services_data_sharing_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./_services/data-sharing.service */ "./src/app/_services/data-sharing.service.ts");
/* harmony import */ var _health_check_result_health_check_result_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./health-check-result/health-check-result.component */ "./src/app/health-check-result/health-check-result.component.ts");
...
/* harmony import */ var _services_route_handler_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./_services/route-handler.service */ "./src/app/_services/route-handler.service.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _services_helpers_interceptor__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./_services/helpers/interceptor */ "./src/app/_services/helpers/interceptor.ts");
/* harmony import */ var _sign_up_verified_sign_up_verified_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./sign-up-verified/sign-up-verified.component */ "./src/app/sign-up-verified/sign-up-verified.component.ts");
/* harmony import */ var _profile_profile_module__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./profile/profile.module */ "./src/app/profile/profile.module.ts");
/* harmony import */ var _edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./edit-profile/edit-profile.component */ "./src/app/edit-profile/edit-profile.component.ts");
/* harmony import */ var angularx_qrcode__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! angularx-qrcode */ "./node_modules/angularx-qrcode/fesm2015/angularx-qrcode.js");
...
/* harmony import */ var _footer_privacy_privacy_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./footer/privacy/privacy.component */ "./src/app/footer/privacy/privacy.component.ts");
/* harmony import */ var _child_mode_edit_child_edit_child_profile_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./child-mode/edit-child/edit-child-profile.component */ "./src/app/child-mode/edit-child/edit-child-profile.component.ts");
/* harmony import */ var _child_mode_add_child_add_child_profile_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./child-mode/add-child/add-child-profile.component */ "./src/app/child-mode/add-child/add-child-profile.component.ts");
/* harmony import */ var _child_mode_add_child_by_code_add_child_by_code_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./child-mode/add-child-by-code/add-child-by-code.component */ "./src/app/child-mode/add-child-by-code/add-child-by-code.component.ts");
/* harmony import */ var _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
/* harmony import */ var _services_language_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./_services/language.service */ "./src/app/_services/language.service.ts");
/* harmony import */ var _news_news_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./news/news.component */ "./src/app/news/news.component.ts");
/* harmony import */ var _article_article_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./article/article.component */ "./src/app/article/article.component.ts");
/* harmony import */ var _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./_services/data-provider/data-provider.service */ "./src/app/_services/data-provider/data-provider.service.ts");
/* harmony import */ var _angular_fire__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! @angular/fire */ "./node_modules/@angular/fire/es2015/index.js");
...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/es2015/index.js");
/* harmony import */ var _angular_fire_auth__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! @angular/fire/auth */ "./node_modules/@angular/fire/auth/es2015/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _header_header_standart_header_standart_component__WEBPACK_IMPORTED_MODULE_7__["HeaderStandartComponent"],
            _header_header_base_header_base_component__WEBPACK_IMPORTED_MODULE_8__["HeaderBaseComponent"],
            _home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"],
            _footer_footer_primary_footer_primary_component__WEBPACK_IMPORTED_MODULE_10__["FooterPrimaryComponent"],
            _footer_footer_white_footer_white_component__WEBPACK_IMPORTED_MODULE_11__["FooterWhiteComponent"],
            _health_test_health_test_component__WEBPACK_IMPORTED_MODULE_12__["HealthTestComponent"],
            _login_login_component__WEBPACK_IMPORTED_MODULE_13__["LoginComponent"],
            _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_14__["SignUpComponent"],
            _sign_up_verified_sign_up_verified_component__WEBPACK_IMPORTED_MODULE_32__["SignUpVerifiedComponent"],
            _restore_password_restore_password_component__WEBPACK_IMPORTED_MODULE_15__["RestorePasswordComponent"],
            _layout_language_selector_language_selector_component__WEBPACK_IMPORTED_MODULE_16__["LanguageSelectorComponent"],
            _layout_dropdown_dropdown_component__WEBPACK_IMPORTED_MODULE_20__["DropdownComponent"],
            _health_check_result_health_check_result_component__WEBPACK_IMPORTED_MODULE_26__["HealthCheckResultComponent"],
            _edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_34__["EditProfileComponent"],
            _footer_privacy_privacy_component__WEBPACK_IMPORTED_MODULE_37__["PrivacyComponent"],
            _child_mode_edit_child_edit_child_profile_component__WEBPACK_IMPORTED_MODULE_38__["EditChildProfileComponent"],
            _child_mode_add_child_add_child_profile_component__WEBPACK_IMPORTED_MODULE_39__["AddChildComponent"],
            _child_mode_add_child_by_code_add_child_by_code_component__WEBPACK_IMPORTED_MODULE_40__["AddChildByCodeComponent"],
            _news_news_component__WEBPACK_IMPORTED_MODULE_43__["NewsComponent"],
            _article_article_component__WEBPACK_IMPORTED_MODULE_44__["ArticleComponent"]
        ],
        imports: [
            _profile_profile_module__WEBPACK_IMPORTED_MODULE_33__["ProfileModule"],
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"].withServerTransition({ appId: 'ng-cli-universal' }),
            _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
            _ng_select_ng_option_highlight__WEBPACK_IMPORTED_MODULE_24__["NgOptionHighlightModule"],
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_17__["NgbModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forRoot([
                { path: 'home', component: _home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"], pathMatch: 'full', canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'health-test', component: _health_test_health_test_component__WEBPACK_IMPORTED_MODULE_12__["HealthTestComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'login', component: _login_login_component__WEBPACK_IMPORTED_MODULE_13__["LoginComponent"] },
                { path: 'sign-up', component: _sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_14__["SignUpComponent"] },
                { path: 'sign-up-verified', component: _sign_up_verified_sign_up_verified_component__WEBPACK_IMPORTED_MODULE_32__["SignUpVerifiedComponent"] },
                { path: 'restore-password', component: _restore_password_restore_password_component__WEBPACK_IMPORTED_MODULE_15__["RestorePasswordComponent"] },
                { path: 'health-check-result', component: _health_check_result_health_check_result_component__WEBPACK_IMPORTED_MODULE_26__["HealthCheckResultComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'edit-profile', component: _edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_34__["EditProfileComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'edit-child-profile/:id', component: _child_mode_edit_child_edit_child_profile_component__WEBPACK_IMPORTED_MODULE_38__["EditChildProfileComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'add-child', component: _child_mode_add_child_add_child_profile_component__WEBPACK_IMPORTED_MODULE_39__["AddChildComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'add-child-by-code', component: _child_mode_add_child_by_code_add_child_by_code_component__WEBPACK_IMPORTED_MODULE_40__["AddChildByCodeComponent"], canActivate: [_services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"]] },
                { path: 'article/:id', component: _article_article_component__WEBPACK_IMPORTED_MODULE_44__["ArticleComponent"] },
                { path: '**', component: _news_news_component__WEBPACK_IMPORTED_MODULE_43__["NewsComponent"] },
            ]),
            // ng-bootstrap modules
            _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_17__["NgbDropdownModule"],
            ...
            _layout_popover_popover_basic_module__WEBPACK_IMPORTED_MODULE_19__["NgbdPopoverBasicModule"],
            _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_23__["NgSelectModule"],
            _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"],
            ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_29__["ToastrModule"].forRoot(),
            angularx_qrcode__WEBPACK_IMPORTED_MODULE_35__["QRCodeModule"],
            _angular_fire__WEBPACK_IMPORTED_MODULE_46__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_47__["environment"].firebase),
        ],
        exports: [
            _layout_language_selector_language_selector_component__WEBPACK_IMPORTED_MODULE_16__["LanguageSelectorComponent"],
        ],
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _services_helpers_interceptor__WEBPACK_IMPORTED_MODULE_31__["AppInterceptor"], multi: true },
            ...
            _services_guard_service__WEBPACK_IMPORTED_MODULE_21__["AuthGuard"],
            _services_localStorage_service__WEBPACK_IMPORTED_MODULE_22__["LocalStorageService"],
            _services_language_service__WEBPACK_IMPORTED_MODULE_42__["LanguageService"],
            _services_data_sharing_service__WEBPACK_IMPORTED_MODULE_25__["DataSharingService"],
            _services_auth_service__WEBPACK_IMPORTED_MODULE_27__["AuthenticationService"],
            _services_route_handler_service__WEBPACK_IMPORTED_MODULE_28__["RouteHandlerService"],
            _services_api_api_service__WEBPACK_IMPORTED_MODULE_30__["ApiService"],
            _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_41__["ApiBaseRequests"],
            _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_45__["DataProviderService"],
            _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_48__["AngularFirestore"],
            _angular_fire_auth__WEBPACK_IMPORTED_MODULE_49__["AngularFireAuth"]
        ],
...
/* harmony import */ var _services_qrCode_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/qrCode.service */ "./src/app/_services/qrCode.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_services/data-provider/data-provider.service */ "./src/app/_services/data-provider/data-provider.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ArticleComponent = class ArticleComponent {
    constructor(modalService, _script, activateRoute, dataProvider) {
  ...
  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.`;
    ...
    openShareDialog(modal) {
        this.modalService.open(modal, { centered: true, windowClass: "myCustomModalClass" }).result.then(r => {
            this.linkCopied = false;
        }, (reason) => {
            this.linkCopied = false;
        });
        this._script.loadScripts('body', [
            ...
            this.qrCode = _services_qrCode_service__WEBPACK_IMPORTED_MODULE_3__["QRCodeService"].generateQRCode(this.firebaseLink);
            console.log(this.qrCode);
            var qrcode = new QRCode(document.getElementById("qrcode"), {
                width: 150,
                height: 150
    ...
    copy() {
        ...
        try {
            ...
            $("#copy-btn").animate({ opacity: 0 }, 150, () => {
                $("#copy-btn span").text("Посилання скопійовано!");
                $("#copy-btn").animate({ opacity: 100 }, 150);
...
ArticleComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./article.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/article/article.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./article.component.scss */ "./src/app/article/article.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbModal"], _services_script_loader_service__WEBPACK_IMPORTED_MODULE_2__["ScriptLoaderService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_5__["DataProviderService"]])
], ArticleComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddChildByCodeComponent", function() { return AddChildByCodeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_models_children_addChildByCodeErrorViewModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_models/children/addChildByCodeErrorViewModel */ "./src/app/_models/children/addChildByCodeErrorViewModel.ts");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
/* harmony import */ var src_app_models_BackendResponseCodes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_models/BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AddChildByCodeComponent = class AddChildByCodeComponent {
    constructor(apiService, toastr, router, activateRoute, modalService) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.router = router;
        this.activateRoute = activateRoute;
    ...
    onClickAddChildByCode() {
        this.loading = true;
        let decodedGuid;
        try {
            let decodeTest = this.base64regex.test(this.childId);
            if (!decodeTest)
                throw src_app_models_BackendResponseCodes__WEBPACK_IMPORTED_MODULE_6__["BackendResponseCode"].CONFLICT;
        ...
        ;
        this.apiService.postAddChildByCode(decodedGuid).subscribe((response) => {
            this.loading = false;
            this.apiService.getUser(decodedGuid).subscribe(response => {
                this.childFirstName = response.firstName;
                this.childLastName = response.lastName;
                this.openModal();
            });
        }, error => {
            this.errorViewModel.setStateErrorByResponseCode(error.status);
            this.loading = false;
        });
    }
    childrenRoute() {
    ...
    openModal() {
        this.modalService.open(this.modalChildComponent, { ariaLabelledBy: 'modal-basic-title', centered: true, size: 'lg' }).result.then((result) => {
            this.childrenRoute();
        }, (reason) => {
            this.childrenRoute();
        });
...
AddChildByCodeComponent.ctorParameters = () => [
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('addChildByCodeResult', { static: false }),
    __metadata("design:type", Object)
], AddChildByCodeComponent.prototype, "modalChildComponent", void 0);
AddChildByCodeComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'add-child-by-code',
        template: __importDefault(__webpack_require__(/*! raw-loader!./add-child-by-code.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/child-mode/add-child-by-code/add-child-by-code.component.html")).default,
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_2__["ToastrManager"],
        _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModal"]])
], AddChildByCodeComponent);
...
/* harmony import */ var _services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _models_children_createChildModel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../_models/children/createChildModel */ "./src/app/_models/children/createChildModel.ts");
/* harmony import */ var src_app_models_children_createChildErrorViewModel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_models/children/createChildErrorViewModel */ "./src/app/_models/children/createChildErrorViewModel.ts");
/* harmony import */ var src_app_services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
/* harmony import */ var src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/_services/helpers/childMapper */ "./src/app/_services/helpers/childMapper.ts");
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var src_app_services_data_sharing_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/_services/data-sharing.service */ "./src/app/_services/data-sharing.service.ts");
/* harmony import */ var src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let AddChildComponent = class AddChildComponent {
    constructor(apiService, toastr, router, localStorageService, dataSharingService, apiBaseRepository) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.router = router;
        this.localStorageService = localStorageService;
    ...
    ngOnInit() {
        ...
        if (!this.countries || !this.states) {
            this.apiBaseRepository.getCountriesStates().then(countriesStates => {
                this.countries = countriesStates.countries;
                this.states = countriesStates.states;
    ...
    finalizeNgOnInit() {
        this.country_USA = this.countries.find(x => x.alpha2Code == _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].USA_COUNTRY_ALPHA2CODE);
        ...
        this.child.gender = 0;
        date_input.change((event) => {
            this.child.dateOfBirth = date_input.val();
            this.formChangedBaseHandler();
        });
    ...
    formChangedBaseHandler() {
        this.checkFormFields();
    }
    checkFormFields() {
        this.createChildErrorViewModel.setStateNoErrors();
        if (!this.child.firstName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__["ValidationService"].ifNameMatchPattern(this.child.firstName))
            this.createChildErrorViewModel.firstNameError = true;
        if (!this.child.lastName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__["ValidationService"].ifNameMatchPattern(this.child.lastName))
            this.createChildErrorViewModel.lastNameError = true;
        if (this.child.gender == undefined)
            this.createChildErrorViewModel.sexError = true;
        if (!this.child.dateOfBirth)
            this.createChildErrorViewModel.dateOfBirthError = true;
        if (!this.child.countryId)
            this.createChildErrorViewModel.countryError = true;
        if (!this.child.stateId)
            this.createChildErrorViewModel.stateError = true;
    }
    onCountrySelected(value) {
        this.USACountrySelected = value === this.country_USA.id;
        if (!this.USACountrySelected)
            this.child.stateId = undefined;
    }
    saveChanges() {
        this.loading = true;
        let body = src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_9__["ChildMapper"].mapCreateChildRequest(this.child);
        ...
        ;
        this.apiService.postChild(body).subscribe((postChildResponse) => {
            this.loading = false;
            this.router.navigate(['/profile/children']);
        }, error => {
            this.loading = false;
            this.toastr.errorToastr('Error occurred!', 'Oops!');
        });
    }
    dateOfBirthIsValid(dateOfBirth) {
        return new Date() >= new Date(dateOfBirth);
    }
};
AddChildComponent.ctorParameters = () => [
    { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] },
...
AddChildComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./add-child-profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/child-mode/add-child/add-child-profile.component.html")).default,
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__["ToastrManager"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
        src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__["LocalStorageService"],
        src_app_services_data_sharing_service__WEBPACK_IMPORTED_MODULE_11__["DataSharingService"],
        src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_12__["ApiBaseRequests"]])
], AddChildComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditChildProfileComponent", function() { return EditChildProfileComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_models_children_createChildErrorViewModel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_models/children/createChildErrorViewModel */ "./src/app/_models/children/createChildErrorViewModel.ts");
/* harmony import */ var src_app_services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
/* harmony import */ var src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/_services/helpers/childMapper */ "./src/app/_services/helpers/childMapper.ts");
/* harmony import */ var src_app_models_children_editChildModel__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/_models/children/editChildModel */ "./src/app/_models/children/editChildModel.ts");
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var src_app_models_children_child__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/_models/children/child */ "./src/app/_models/children/child.ts");
/* harmony import */ var src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
let EditChildProfileComponent = class EditChildProfileComponent {
    constructor(apiService, toastr, router, activateRoute, localStorageService, apiBaseRepository) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.router = router;
        this.activateRoute = activateRoute;
    ...
    finalizeNgOnInit() {
        this.country_USA = this.countries.find(x => x.alpha2Code == _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].USA_COUNTRY_ALPHA2CODE);
        this.apiService.getUser(this.childId).subscribe((getUserResponse) => {
            this.child = src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_8__["ChildMapper"].mapGetUserByIdResponseToChildModel(this.childId, getUserResponse);
            this.editChildModel = src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_8__["ChildMapper"].mapChildToEditChildMoldel(this.child);
    ...
    checkFormFields() {
        ...
        if (!this.editChildModel.firstName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__["ValidationService"].ifNameMatchPattern(this.editChildModel.firstName))
            this.editProfileErrorViewModel.firstNameError = true;
        if (!this.editChildModel.lastName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_4__["ValidationService"].ifNameMatchPattern(this.editChildModel.lastName))
            this.editProfileErrorViewModel.lastNameError = true;
        if (this.editChildModel.gender == undefined)
            this.editProfileErrorViewModel.sexError = true;
        if (!this.editChildModel.dateOfBirth)
            this.editProfileErrorViewModel.dateOfBirthError = true;
        if (!this.editChildModel.countryId)
            this.editProfileErrorViewModel.countryError = true;
        if (!this.editChildModel.stateId)
            this.editProfileErrorViewModel.stateError = true;
    }
    onCountrySelected(value) {
        this.USACountrySelected = value === this.country_USA.id;
        if (!this.USACountrySelected)
            this.editChildModel.stateId = undefined;
    }
    saveChanges() {
        this.loading = true;
        let body = src_app_services_helpers_childMapper__WEBPACK_IMPORTED_MODULE_8__["ChildMapper"].mapEditChildRequest(this.editChildModel);
        this.apiService.updateChildProfile(this.child.id, body).subscribe((response) => {
            this.loading = false;
            if (response.success) {
                ...
                this.toastr.errorToastr(response.errors.join(','), 'Error');
            }
        }, error => {
            this.toastr.errorToastr('Error occurred', 'Oops!');
            this.loading = false;
...
EditChildProfileComponent.ctorParameters = () => [
    { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] },
    { type: ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__["ToastrManager"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
...
EditChildProfileComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'edit-children-profile',
        template: __importDefault(__webpack_require__(/*! raw-loader!./edit-child-profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/child-mode/edit-child/edit-child-profile.component.html")).default,
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__["ToastrManager"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
...
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _models_profile_profileModels__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_models/profile/profileModels */ "./src/app/_models/profile/profileModels.ts");
/* harmony import */ var _services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_localStorage_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let EditProfileComponent = class EditProfileComponent {
    constructor(apiService, toastr, router, localStorageService) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.router = router;
        this.localStorageService = localStorageService;
    ...
    ngOnInit() {
        ...
        if (this.editUserModel.dateOfBirthViewModel) {
            let userDateOfBirth = new Date(this.editUserModel.dateOfBirthViewModel);
            $("#dateOfBirth-new").datepicker("setDate", userDateOfBirth);
        }
        date_input.change((event) => {
            this.editUserModel.dateOfBirthViewModel = date_input.val();
            this.formChangedBaseHandler();
        });
    }
    initEditProfileModels() {
    ...
    checkFormFields() {
        ...
        if (!this.editUserModel.email || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifEmailMatchPattern(this.editUserModel.email))
            this.editProfileErrorViewModel.emailError = true;
        if (!this.editUserModel.phone)
            this.editProfileErrorViewModel.phoneError = true;
        if (!this.editUserModel.firstName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifNameMatchPattern(this.editUserModel.firstName))
            this.editProfileErrorViewModel.firstNameError = true;
        if (!this.editUserModel.lastName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifNameMatchPattern(this.editUserModel.lastName))
            this.editProfileErrorViewModel.lastNameError = true;
        if (this.editUserModel.gender == undefined)
            this.editProfileErrorViewModel.sexError = true;
        if (!this.editUserModel.dateOfBirthViewModel)
            this.editProfileErrorViewModel.dateOfBirthError = true;
        if (!this.editUserModel.countryId)
            this.editProfileErrorViewModel.countryError = true;
        if (!this.editUserModel.stateId)
            this.editProfileErrorViewModel.stateError = true;
    }
    onCountrySelected(value) {
        this.USACountrySelected = value === this.country_USA.id;
    ...
    saveChanges() {
        ...
        this.loading = true;
        this.apiService.updateProfile(this.user.id, this.editUserModel).subscribe((response) => {
            this.loading = false;
            if (response.success) {
                this.toastr.successToastr("Profile updated successfully", 'Success!');
                this.mapUserFromUpdateResponse(response);
    ...
    mapUserFromUpdateResponse(response) {
        let actualUserModel = JSON.parse(localStorage.getItem('currentUser'));
...
EditProfileComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./edit-profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/edit-profile/edit-profile.component.html")).default,
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_3__["ToastrManager"],
...
let FooterPrimaryComponent = class FooterPrimaryComponent {
...
FooterPrimaryComponent.ctorParameters = () => [
    { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbModal"] }
];
FooterPrimaryComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: "app-footer-primary",
        template: __importDefault(__webpack_require__(/*! raw-loader!./footer-primary.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/footer/footer-primary/footer-primary.component.html")).default,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FooterWhiteComponent", function() { return FooterWhiteComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
let FooterWhiteComponent = class FooterWhiteComponent {
    constructor() {
...
FooterWhiteComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: "app-footer-white",
        template: __importDefault(__webpack_require__(/*! raw-loader!./footer-white.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/footer/footer-white/footer-white.component.html")).default,
        encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
    }),
...
PrivacyComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./privacy.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/footer/privacy/privacy.component.html")).default,
    }),
    __metadata("design:paramtypes", [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_1__["NgbModal"]])
], PrivacyComponent);
...
let HeaderBaseComponent = class HeaderBaseComponent {
    constructor(_router, _script) {
        this._router = _router;
        this._script = _script;
...
HeaderBaseComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: _services_script_loader_service__WEBPACK_IMPORTED_MODULE_2__["ScriptLoaderService"] }
];
HeaderBaseComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'header-base',
        template: __importDefault(__webpack_require__(/*! raw-loader!./header-base.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/header/header-base/header-base.component.html")).default,
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HeaderStandartComponent", function() { return HeaderStandartComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HeaderStandartComponent = class HeaderStandartComponent {
    constructor(_router, localStorageService) {
        this._router = _router;
        this.localStorageService = localStorageService;
    }
    ngOnInit() {
...
HeaderStandartComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"] }
];
HeaderStandartComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'header-standart',
        template: __importDefault(__webpack_require__(/*! raw-loader!./header-standart.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/header/header-standart/header-standart.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./header-standart.component.scss */ "./src/app/header/header-standart/header-standart.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HealthCheckResultComponent", function() { return HealthCheckResultComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
let HealthCheckResultComponent = class HealthCheckResultComponent {
    constructor(_router, toastr) {
        this._router = _router;
        this.toastr = toastr;
    }
    ngOnInit() {
        let responseModel = JSON.parse(localStorage.getItem('checkModel'));
    ...
    parseResponseModel(checkResponseModel) {
    ...
    downloadQRCode() {
        let qrCodeSrc = '';
        try {
            let qrCodeHtmlElement = document.querySelector('.qrcode');
            let child = qrCodeHtmlElement.childNodes[0];
            qrCodeSrc = child.src;
        }
        catch (exception) {
            this.toastr.errorToastr('Error occurred when trying to generate HealthTest result!', 'Oops!', { showCloseButton: true });
            return;
        }
    }
};
HealthCheckResultComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
    { type: ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_2__["ToastrManager"] }
];
HealthCheckResultComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-health-check-result',
        template: __importDefault(__webpack_require__(/*! raw-loader!./health-check-result.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/health-check-result/health-check-result.component.html")).default
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_2__["ToastrManager"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HealthTestComponent", function() { return HealthTestComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _models_health_test_viewModels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_models/health-test/viewModels */ "./src/app/_models/health-test/viewModels.ts");
...
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _services_customQuestionWizard_customSurveyWizard_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../_services/customQuestionWizard/customSurveyWizard.service */ "./src/app/_services/customQuestionWizard/customSurveyWizard.service.ts");
...
/* harmony import */ var _models_health_test_HealthCheckModel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_models/health-test/HealthCheckModel */ "./src/app/_models/health-test/HealthCheckModel.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let HealthTestComponent = class HealthTestComponent {
    constructor(_router, localStorageService, apiService, toastr, languageService) {
        this._router = _router;
        this.localStorageService = localStorageService;
        this.apiService = apiService;
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this.apiService.getChildren().subscribe((response) => {
            this.children = response.items;
            if (!this.children || this.children.length == 0) {
                this.chooseIdentity(this.user);
            }
            else {
                this.healthTestViewModel.setStateChooseIdentity();
            }
        });
    }
    chooseIdentity(identity) {
        this.healthTestViewModel.setStateLoading();
        this.apiService.getUser(identity.id).subscribe(getUserByIdResponse => {
            this.currentIdentity = getUserByIdResponse;
            this.currentIdentity.id = identity.id;
            this.facilityList = this.currentIdentity.facilities;
            this.healthTestViewModel.setStateChooseFacility();
            this.fillOutFacilitySelectInput();
        });
    }
    fillOutFacilitySelectInput() {
    ...
    onChangeSelectFalilityDropdown() {
        if (!this.currentIdentity || !this.currentIdentity.facilities)
            return;
        this.healthTestViewModel.questionsListIsEmpty = false;
        this.currentFacility = this.currentIdentity.facilities.find(x => { return x.facilityId === this.selectFacility; });
        this.healthTestViewModel.questionsListIsEmpty =
            !(this.currentFacility && this.currentFacility.questions && this.currentFacility.questions.length > 0);
    }
    handleAnswer(answer) {
    ...
    finishTheTest() {
        this.healthTestViewModel.setStateLoading();
        let requestModel = this.customSurveyWizard.getSurveyAnswers(this.currentIdentity.id, this.currentFacility.id, this.currentFacility.surveyId);
        this.apiService.checkTest(requestModel).subscribe((response) => {
            this.navigateToTheTestResult(response);
        }, error => {
            console.error(error);
            this.toastr.errorToastr('Error occurred!<br><br><p>Please, try again in 10 minutes!</p>', 'Oops!', { enableHTML: true, dismiss: "click", showCloseButton: true });
            this.chooseIdentity(this.currentIdentity);
        });
    }
    navigateToTheTestResult(response) {
        let checkModelDTO = new _models_health_test_HealthCheckModel__WEBPACK_IMPORTED_MODULE_8__["CheckModelDTO"]();
...
HealthTestComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
...
HealthTestComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-health-test',
        template: __importDefault(__webpack_require__(/*! raw-loader!./health-test.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/health-test/health-test.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./health-test.component.scss */ "./src/app/health-test/health-test.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
...
DropdownComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./dropdown.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/dropdown/dropdown.component.html")).default,
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_2__["LocalStorageService"]])
], DropdownComponent);
...
LanguageSelectorComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./language-selector.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/language-selector/language-selector.component.html")).default,
    }),
    __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NgbdPopoverBasicModule", function() { return NgbdPopoverBasicModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
/* harmony import */ var _popover_basic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./popover-basic */ "./src/app/layout/popover/popover-basic.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let NgbdPopoverBasicModule = class NgbdPopoverBasicModule {
};
NgbdPopoverBasicModule = __decorate([
...
NgbdPopoverBasic = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./popover-basic.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/layout/popover/popover-basic.html")).default
    })
], NgbdPopoverBasic);
...
/* harmony import */ var _models_BackendResponseCodes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_models/BackendResponseCodes */ "./src/app/_models/BackendResponseCodes.ts");
...
/* harmony import */ var _models_sign_in_signInModels__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../_models/sign-in/signInModels */ "./src/app/_models/sign-in/signInModels.ts");
/* harmony import */ var _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let LoginComponent = class LoginComponent {
    constructor(_router, authService, modalService, toastr, route, apiService, localStorageService, apiHelper) {
        this._router = _router;
        this.authService = authService;
        this.modalService = modalService;
        this.toastr = toastr;
    ...
    ngOnInit() {
        this.route.queryParams.subscribe(params => {
            let activationModel = new _models_sign_in_signInModels__WEBPACK_IMPORTED_MODULE_7__["ActivationRequestModel"]();
            ...
            this.loading = true;
            this.activationViewModel.setStateActivationInProgress();
            _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__["ContentHelper"].showEmailVerifyModal();
            this.authService.confirmEmailToken(activationModel).subscribe((response) => {
                this.loading = false;
                this.activationViewModel.setStateRequestReceived(response.success);
            }, error => {
                this.loading = false;
                this.activationViewModel.setStateRequestReceived(false);
            });
        });
    }
    formChangeValue(event) {
        this.signInErrorViewModel.setStateNoError();
    }
    signIn(form) {
        this.loading = true;
        this.authService.login(this.userLoginModel).subscribe((response) => __awaiter(this, void 0, void 0, function* () {
            if (!response.success) {
                this.loading = false;
            ...
            yield this.apiHelper.getChildren();
            this._router.navigate(['/home']);
        }), error => {
            this.toastr.errorToastr(`Error occurred! <br>${error.message}`, 'Oops!', { enableHTML: true, dismiss: "click", showCloseButton: true });
            this.loading = false;
        });
    }
    ...
    setDefaultTemperatureScaleIfNecessary(user) {
        if (user.temperatureScale)
            return;
        ...
        let defaultTemperatureFahrenheit = user.availableTemperatureScales.find(x => x.name == 'Fahrenheit');
        if (defaultTemperatureFahrenheit)
            user.temperatureScale = defaultTemperatureFahrenheit;
        else {
    ...
    closeModalVerify() {
        if (this.activationViewModel.activationInProgress)
            return;
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
        ...
        _services_api_api_service__WEBPACK_IMPORTED_MODULE_9__["ApiService"],
        _services_localStorage_service__WEBPACK_IMPORTED_MODULE_10__["LocalStorageService"],
        _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_11__["ApiBaseRequests"]])
], LoginComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/data-provider/data-provider.service */ "./src/app/_services/data-provider/data-provider.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let NewsComponent = class NewsComponent {
    constructor(_router, dateProvider) {
        this._router = _router;
    ...
    ngOnInit() {
        ...
        this.dateProvider.init().then(() => {
            this.dateProvider.getAll().then(res => {
                this.fireNews = res;
                //this.fireNewsRows = DataProviderExtension.splitSequenceToRows(res, 3);
                this.loading = false;
            });
        });
    }
    onClickOpenItem(item) {
        ...
        console.log(item);
        this._router.navigate(['/article', item.id], { state: item });
    }
};
...
NewsComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        styles: [__importDefault(__webpack_require__(/*! ./news.component.scss */ "./src/app/news/news.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_data_provider_data_provider_service__WEBPACK_IMPORTED_MODULE_2__["DataProviderService"]])
], NewsComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChildCardComponent", function() { return ChildCardComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_profile_addFacilityViewModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_models/profile/addFacilityViewModel */ "./src/app/_models/profile/addFacilityViewModel.ts");
/* harmony import */ var src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var src_app_models_children_child__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_models/children/child */ "./src/app/_models/children/child.ts");
...
let ChildCardComponent = class ChildCardComponent {
    constructor(apiService, router, localStorageService, modalService) {
        this.apiService = apiService;
        this.router = router;
        this.localStorageService = localStorageService;
        this.modalService = modalService;
    ...
    ngOnInit() {
        this.loading = true;
        let children = this.localStorageService.getChildren();
        this.child = children.find((item) => { return item.id === this.childId; });
        this.loading = false;
        if (!this.child) {
            this.child = new src_app_models_children_child__WEBPACK_IMPORTED_MODULE_5__["Child"]();
            console.error("ChildById not found");
            console.error(`Id: ${this.childId}`);
            this.router.navigate(['/profile/my-profile']);
            return;
        }
    ...
    routeEditChild() {
        let childId = btoa(this.child.id);
        this.router.navigate([
            `edit-child-profile/${childId}`
        ]);
    }
    onClickAddFacilityInput() {
        if (!this.addFacilityDialogViewModel.newFacilityCode || this.addFacilityDialogViewModel.facilityErrorPopover.popowerIsVisible)
            return;
        this.addFacilityDialogViewModel.loading = true;
        let getFacilityResponseBody = { facilityCode: this.addFacilityDialogViewModel.newFacilityCode };
        this.apiService.getFacilityCode(getFacilityResponseBody).subscribe((response) => {
            if (!response.success) {
                this.addFacilityDialogViewModel.handleResponse(response);
                this.addFacilityDialogViewModel.loading = false;
                return;
            }
            let body = { userId: this.child.id, facilityCode: this.addFacilityDialogViewModel.newFacilityCode };
            this.apiService.addFacility(body).subscribe((response) => {
                this.child.facilities = response;
                this.addFacilityDialogViewModel.loading = false;
                this.addFacilityDialogViewModel.setAddFacilityDialogIsActive(false);
            });
        });
    }
    openModalShareProfile(shareprofilemodal) {
    }
    copyChildId() {
        try {
            let selBox = document.createElement('textarea');
            ...
            document.execCommand('copy');
            document.body.removeChild(selBox);
            $("#copyChildIdBtn").animate({ opacity: 0 }, 150, () => {
                $("#copyChildIdBtn span").text("Child Id copied to clipboard");
                $("#copyChildIdBtn").animate({ opacity: 100 }, 150);
            });
        }
        catch (ex) {
            $("#copyChildIdBtn").animate({ opacity: 0 }, 150, () => {
                $("#copyChildIdBtn").text("Oops! Error occurred.");
                $("#copyChildIdBtn").css({ color: '#c43737' });
                $("#copyChildIdBtn").animate({ opacity: 100 }, 150);
            });
        }
    }
};
ChildCardComponent.ctorParameters = () => [
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
    __metadata("design:type", Object)
], ChildCardComponent.prototype, "childId", void 0);
ChildCardComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'child-card',
        template: __importDefault(__webpack_require__(/*! raw-loader!./child-card.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/children/child-card-component/child-card.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./child-card.component.scss */ "./src/app/profile/children/child-card-component/child-card.component.scss")).default]
    }),
    __metadata("design:paramtypes", [src_app_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_4__["LocalStorageService"],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_models_profile_addFacilityViewModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/_models/profile/addFacilityViewModel */ "./src/app/_models/profile/addFacilityViewModel.ts");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var src_app_models_AppConstants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var src_app_models_profile_changePasswordViewModel__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/_models/profile/changePasswordViewModel */ "./src/app/_models/profile/changePasswordViewModel.ts");
/* harmony import */ var src_app_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
...
/* harmony import */ var src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
/* harmony import */ var src_app_services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let ChildrenComponent = class ChildrenComponent {
    constructor(apiService, toastr, localStorageService, _router, modalService, apiHelper) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.localStorageService = localStorageService;
        this._router = _router;
    ...
    ngOnInit() {
        ...
        this.apiHelper.getChildren().then(() => {
            this.children = this.localStorageService.getChildren();
            this.loading = false;
            if (this._router.url === "/profile/children")
                src_app_services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_11__["ContentHelper"].chooseTabMyProfileChildren();
            if (!this.children || this.children.length == 0) {
    ...
    onClickAddFacilityInput() {
        ...
        this.apiService.getFacilityCode(getFacilityResponseBody).subscribe((response) => {
            ...
            let body = { userId: this.user.id, facilityCode: this.addFacilityDialogViewModel.newFacilityCode };
            this.apiService.addFacility(body).subscribe((response) => {
                this.user.userFacility = response;
                localStorage.setItem(src_app_models_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].LOCAL_STORAGE_USER_KEY, JSON.stringify(this.user));
                this.addFacilityDialogViewModel.loading = false;
                this.addFacilityDialogViewModel.setAddFacilityDialogIsActive(false);
            });
        });
    ...
    onClickOpenChangePasswordDialog() {
    ...
    changePassword(isValid) {
        ...
        let body = { newPassword: this.changePasswordViewModel.newPassword };
        this.apiService.updatePassword(body).subscribe((response) => {
            this.changePasswordViewModel.setChangePasswordDialogisActive(false);
            if (response.success) {
                this.toastr.successToastr(`Password updated successfully`, 'Success!', { enableHTML: true, showCloseButton: true });
            }
            else
                this.changePasswordViewModel.passwordErrorPopover.showPopower(response.errors.join(','));
        }, error => {
            this.toastr.errorToastr('Error occurred', 'Oops!');
        });
    }
    onChangeNewPassword() {
        ...
        if (!this.changePasswordViewModel.newPassword || !src_app_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifPasswordMatchPattern(this.changePasswordViewModel.newPassword))
    ...
    closeDialogAddFacility() {
        if (!this.addFacilityDialogViewModel.loading)
            this.addFacilityDialogViewModel.setAddFacilityDialogIsActive(false);
    }
    closeDialogChangePassword() {
        if (!this.changePasswordViewModel.loading)
            this.changePasswordViewModel.setChangePasswordDialogisActive(false);
    }
    onClickCreateChildRoute() {
        this._router.navigate(['/add-child']);
    }
    onClickAddChildByCodeRoute() {
        this._router.navigate(['/add-child-by-code']);
    }
    onClickEditChild(id) {
        this._router.navigate(['/edit-children-profile']);
    }
    openModalAddChild(addchildmodal) {
        this.modalService.open(addchildmodal, { centered: true, size: 'lg' });
    }
};
...
ChildrenComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./children.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/children/children.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./children.component.scss */ "./src/app/profile/children/children.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"],
        ...
        src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_10__["ApiBaseRequests"]])
], ChildrenComponent);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
/* harmony import */ var src_app_services_data_sharing_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/_services/data-sharing.service */ "./src/app/_services/data-sharing.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let MyProfileComponent = class MyProfileComponent {
    constructor(apiService, toastr, localStorageService, _router, modalService, dataSharingService) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.localStorageService = localStorageService;
        this._router = _router;
    ...
    openModalDeleteFacility(deletefacilitymodal, facility) {
        this.facilityToDelete = facility;
        this.modalService.open(deletefacilitymodal, { centered: true, size: 'lg' });
    }
    deleteFacility() {
        if (!this.facilityToDelete)
            return;
        this.deleteFacilityInProgress = true;
        this.user.userFacility = this.user.userFacility.filter(x => { return x.id !== this.facilityToDelete.id; });
        this.apiService.leaveFacility(this.user.id, this.facilityToDelete.id).subscribe(response => {
            this.deleteFacilityInProgress = false;
            this.facilityToDelete = null;
            this.localStorageService.setUser(this.user);
        }, error => {
            this.toastr.errorToastr(`Error occurred during deleting facility ${this.facilityToDelete.name}!`, 'Oops!');
            this.user.userFacility.push(this.facilityToDelete);
            this.facilityToDelete = null;
            this.deleteFacilityInProgress = false;
        });
    }
...
MyProfileComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'my-profile',
        template: __importDefault(__webpack_require__(/*! raw-loader!./my-profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/my-profile/my-profile.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./my-profile.component.scss */ "./src/app/profile/my-profile/my-profile.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_6__["ToastrManager"],
        src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_7__["LocalStorageService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_8__["Router"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_9__["NgbModal"],
        src_app_services_data_sharing_service__WEBPACK_IMPORTED_MODULE_10__["DataSharingService"]])
], MyProfileComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyResultComponent", function() { return MyResultComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var src_app_models_AppConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
/* harmony import */ var src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
/* harmony import */ var src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let MyResultComponent = class MyResultComponent {
    constructor(apiService, _router, toastr, localStorageService, apiBaseRequests) {
        this.apiService = apiService;
        this._router = _router;
        this.toastr = toastr;
        this.localStorageService = localStorageService;
    ...
    initIdentities() {
        ...
        children.forEach(item => {
            this.identities.push(this.mapDropdownIdentityModel(item.id, item.firstName, item.lastName));
        });
    }
    mapDropdownIdentityModel(id, firstName, lastName) {
        let identity = {};
        identity.id = id;
    ...
    sortResults(month) {
        ...
        this.checks = this.allUserChecks.filter(x => {
            let mn = x.dateTime.getMonth();
            return mn == month;
        });
        this.loading = false;
        if (this.checks.length == 0)
    ...
    onChangeDropdownIdentity(event) {
    ...
    getChecksByIdentity(identityId) {
        this.loading = true;
        this.apiService.getChecks(identityId).subscribe(response => {
            this.mapGetCheckResponseToCheck(response);
            this.monthOnChange();
            this.currentIdentitiy = this.identities.find(x => { return x.id == identityId; });
            this.loading = false;
        });
    }
    onChooseResult(event) {
        this.cardLoading = true;
        let cardResult = $(`#${event.id}`);
    ...
    downloadQRCode(event) {
        ...
        let currentCheck = this.checks.find(x => x.id == event.id);
        let qrCodeSrc = '';
        try {
            let qrCodeHtmlElement = document.getElementById(`qrcode-${event.id}`).childNodes[0];
            let child = qrCodeHtmlElement.childNodes[0];
            qrCodeSrc = child.src;
        }
        catch (exception) {
    ...
    openCardById(id) {
        ...
        let currentCheck = this.checks.find(x => x.id == id);
        this.cardLoading = false;
    }
    closeCardById(id) {
        let cardResult = $(`#${id}`);
    ...
    mapGetCheckResponseToCheck(getChecksResponse) {
        this.allUserChecks = getChecksResponse.items;
        this.allUserChecks.sort((x1, x2) => x2.timestamp - x1.timestamp);
        this.allUserChecks.forEach(x => {
...
MyResultComponent.ctorParameters = () => [
    { type: _services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
MyResultComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'my-result',
        template: __importDefault(__webpack_require__(/*! raw-loader!./my-result.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profile/my-results/my-result.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./my-result.component.scss */ "./src/app/profile/my-results/my-result.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"],
        _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_4__["ToastrManager"],
        src_app_services_localStorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"],
        src_app_services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_6__["ApiBaseRequests"]])
], MyResultComponent);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _services_data_sharing_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/data-sharing.service */ "./src/app/_services/data-sharing.service.ts");
/* harmony import */ var _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../_services/helpers/apiBaseRequests */ "./src/app/_services/helpers/apiBaseRequests.ts");
...
let ProfileComponent = class ProfileComponent {
    constructor(_router, localStorageService, dataSharingService, apiService, apiHelper) {
        this._router = _router;
        this.localStorageService = localStorageService;
        this.dataSharingService = dataSharingService;
        this.apiService = apiService;
    ...
    getChildrenfromBackend() {
        this.apiService.getChildren().subscribe((response) => {
            ...
            this.hasChildren = response.items.length > 0;
        });
    }
};
...
ProfileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_localStorage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"],
        ...
        _services_helpers_apiBaseRequests__WEBPACK_IMPORTED_MODULE_4__["ApiBaseRequests"]])
], ProfileComponent);
...
/* harmony import */ var _my_profile_my_profile_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./my-profile/my-profile.component */ "./src/app/profile/my-profile/my-profile.component.ts");
/* harmony import */ var _my_results_my_result_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./my-results/my-result.component */ "./src/app/profile/my-results/my-result.component.ts");
...
/* harmony import */ var angularx_qrcode__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! angularx-qrcode */ "./node_modules/angularx-qrcode/fesm2015/angularx-qrcode.js");
/* harmony import */ var _services_data_sharing_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../_services/data-sharing.service */ "./src/app/_services/data-sharing.service.ts");
/* harmony import */ var _children_child_card_component_child_card_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./children/child-card-component/child-card.component */ "./src/app/profile/children/child-card-component/child-card.component.ts");
/* harmony import */ var _children_children_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./children/children.component */ "./src/app/profile/children/children.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
ProfileModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        declarations: [
            ...
            _my_results_my_result_component__WEBPACK_IMPORTED_MODULE_3__["MyResultComponent"],
            _profile_component__WEBPACK_IMPORTED_MODULE_4__["ProfileComponent"],
            _children_child_card_component_child_card_component__WEBPACK_IMPORTED_MODULE_11__["ChildCardComponent"],
            _children_children_component__WEBPACK_IMPORTED_MODULE_12__["ChildrenComponent"]
        ],
        imports: [
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var _models_restorePassword_restorePasswordModels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_models/restorePassword/restorePasswordModels */ "./src/app/_models/restorePassword/restorePasswordModels.ts");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ng-bootstrap/ng-bootstrap */ "./node_modules/@ng-bootstrap/ng-bootstrap/fesm2015/ng-bootstrap.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
let RestorePasswordComponent = class RestorePasswordComponent {
    constructor(apiService, toastr, router, modalService) {
        this.apiService = apiService;
        this.toastr = toastr;
        this.router = router;
        this.modalService = modalService;
    ...
    restorePassword() {
        this.loading = true;
        this.apiService.restorePassword(this.restorePasswordModel).subscribe((response) => {
            this.loading = false;
            if (response.success) {
                this.openModal();
            }
                ...
                if (response.code === 1000) {
                    this.toastr.errorToastr(`<b>Application error</b><br>${response.message}`, 'Oops!', { enableHTML: true });
                }
                else {
                    this.restorePasswordErrorViewModel.setStateErrorByResponseCode(response.code);
                }
            }
        }, error => {
            this.toastr.errorToastr(`Error occured!`, 'Oops!', { enableHTML: true, dismiss: "click", showCloseButton: true });
            this.loading = false;
        });
    }
    onChangeValue() {
...
__decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('restoreResult', { static: false }),
    __metadata("design:type", Object)
], RestorePasswordComponent.prototype, "modalChildComponent", void 0);
RestorePasswordComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'app-restore-password',
        template: __importDefault(__webpack_require__(/*! raw-loader!./restore-password.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/restore-password/restore-password.component.html")).default,
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"],
        ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_4__["ToastrManager"],
        _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_6__["NgbModal"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SignUpVerifiedComponent", function() { return SignUpVerifiedComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
let SignUpVerifiedComponent = class SignUpVerifiedComponent {
    constructor() { }
    ngOnInit() {
    }
};
SignUpVerifiedComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        selector: 'sign-up-verified',
        template: __importDefault(__webpack_require__(/*! raw-loader!./sign-up-verified.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sign-up-verified/sign-up-verified.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./sign-up-verified.component.scss */ "./src/app/sign-up-verified/sign-up-verified.component.scss")).default]
    }),
    __metadata("design:paramtypes", [])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _models_sign_up_signUpModel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../_models/sign-up/signUpModel */ "./src/app/_models/sign-up/signUpModel.ts");
/* harmony import */ var _services_api_api_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_services/api/api.service */ "./src/app/_services/api/api.service.ts");
/* harmony import */ var _models_AppConstants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_models/AppConstants */ "./src/app/_models/AppConstants.ts");
/* harmony import */ var ng6_toastr_notifications__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ng6-toastr-notifications */ "./node_modules/ng6-toastr-notifications/fesm2015/ng6-toastr-notifications.js");
/* harmony import */ var _services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../_services/helpers/validationService */ "./src/app/_services/helpers/validationService.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
...
/* harmony import */ var _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../_services/helpers/contentHelper */ "./src/app/_services/helpers/contentHelper.ts");
/* harmony import */ var _services_localStorage_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../_services/localStorage.service */ "./src/app/_services/localStorage.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let SignUpComponent = class SignUpComponent {
    constructor(apiService, localStoregeService, toastr, router, _script) {
        this.apiService = apiService;
    ...
    ngOnInit() {
        ...
        this.apiService.getCountries().subscribe((response) => {
            ...
            this.country_USA = this.countries.find(x => x.alpha2Code === _models_AppConstants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].USA_COUNTRY_ALPHA2CODE);
            ...
            this.apiService.getStates().subscribe((response) => {
                ...
                if (countryUSA) {
                    this.userSignUpModel.countryId = countryUSA.id;
                    this.onCountrySelected(countryUSA.id);
                }
                _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__["ContentHelper"].setLoading(false);
            }, error => {
                _services_helpers_contentHelper__WEBPACK_IMPORTED_MODULE_8__["ContentHelper"].setLoading(false);
        ...
        date_input.datepicker();
        date_input.change((event) => {
            this.userSignUpModel.dateOfBirthForView = date_input.val();
            this.formChangedBaseHandler();
        });
    }
    signUp(form) {
        ...
        this.apiService.signUp(this.userSignUpModel).subscribe((response) => {
            if (!response.success) {
                this.signUpErrorViewModel.setStateErrorByResponseCode(response.code);
                this.loading = false;
                return;
            }
            this.router.navigate(['/sign-up-verified']);
        }, error => {
            this.loading = false;
        });
    }
    ...
    checkFormFields() {
        ...
        if (!this.userSignUpModel.password || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifPasswordMatchPattern(this.userSignUpModel.password))
            this.signUpErrorViewModel.passwordError = true;
        if (!this.userSignUpModel.phone)
            this.signUpErrorViewModel.phoneError = true;
        if (!this.userSignUpModel.firstName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifNameMatchPattern(this.userSignUpModel.firstName))
            this.signUpErrorViewModel.firstNameError = true;
        if (!this.userSignUpModel.lastName || !_services_helpers_validationService__WEBPACK_IMPORTED_MODULE_5__["ValidationService"].ifNameMatchPattern(this.userSignUpModel.lastName))
            this.signUpErrorViewModel.lastNameError = true;
        if (this.userSignUpModel.gender == undefined)
            this.signUpErrorViewModel.sexError = true;
        if (!this.userSignUpModel.dateOfBirthForView)
            this.signUpErrorViewModel.dateOfBirthError = true;
        if (!this.userSignUpModel.countryId)
            this.signUpErrorViewModel.countryError = true;
        if (!this.userSignUpModel.stateId)
            this.signUpErrorViewModel.stateError = true;
        if (!this.userSignUpModel.facilityCode)
            this.signUpErrorViewModel.facilityCodeError = true;
        if (!this.userSignUpModel.eula)
            this.signUpErrorViewModel.termsAndConditionError = true;
    }
    closeModalPrivacy() {
        var body = document.querySelector('body');
        body.classList.remove('modal-open-privacy');
...
SignUpComponent = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
        ...
        template: __importDefault(__webpack_require__(/*! raw-loader!./sign-up.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/sign-up/sign-up.component.html")).default,
        styles: [__importDefault(__webpack_require__(/*! ./sign-up.component.scss */ "./src/app/sign-up/sign-up.component.scss")).default]
    }),
    __metadata("design:paramtypes", [_services_api_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"],
...
module.exports = __webpack_require__(/*! C:\Users\shala\Documents\GitHub\MyCity\city-v2\src\main.ts */"./src/main.ts");
