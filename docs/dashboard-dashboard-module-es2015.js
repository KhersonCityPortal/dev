...
DialogOverviewExampleDialog.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DialogOverviewExampleDialog, selectors: [["dialog-share"]], decls: 16, vars: 7, consts: [[1, "close-modal", 3, "mat-dialog-close"], [1, "modal-header"], ["src", "assets/images/background/city-small.png", "alt", "My city"], [1, "article-title--wrap"], ["style", "text-align: center;", 4, "ngIf"], [1, "article-url"], [1, "qrcodeImage"], ["id", "qrcode", 1, "", 2, "display", "flex", "justify-content", "center", 3, "ngClass"], [4, "ngIf"], [2, "text-align", "center"], [3, "loading"], ["id", "copy-btn", "mat-button", "", 3, "click"], [2, "margin-left", "5px"]], template: function DialogOverviewExampleDialog_Template(rf, ctx) { if (rf & 1) {
